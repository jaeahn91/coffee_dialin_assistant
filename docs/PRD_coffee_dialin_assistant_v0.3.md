...
6. **파일럿·현장 피드백 현황 반영**: 로스터리 1곳과 무상 파일럿 실험을 구두 협의(§3). 격자의 조정 수위가 해당 로스터리 대표의 현장 피드백을 반영해 결정된 것임을 명시(§6-1).
...
- (v0.3 추가) 파일럿 후보 확보: 로스터리 1곳과 무상 제공 조건의 파일럿 실험을 구두 협의함. QR 발급이 가능해지는 시점에 시작 예정.
...
- (v0.3 추가) 격자의 조정 수위(한 번에 한 변수, 보수적 기조)는 파일럿 후보 로스터리 대표의 현장 피드백을 반영해 결정한 것이다. 추출 변수를 아주 세밀하게 따지는 고객은 많지 않다는 의견에 따라, 질문은 단순하게 받고 처방은 작게 움직이는 방향을 기본으로 한다.
