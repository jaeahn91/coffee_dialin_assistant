...
- **파일럿 로스터 방문**: 체크리스트는 `docs/visit-checklist.md`에 정리(디자인 반응·실데이터 신호·이연 결정·셀프서비스 수요). 핵심 신호: gpze QR에 high/short 연속 4회로 온도 93→90 — 실추출이면 기준 93°C가 높은 것일 수 있음. 방문 전 깨끗한 데모 QR 발급 권장.
